import { A as AstroError, bl as MissingSharp } from './sequence_DTZMoSxv.mjs';
import { b as baseService, p as parseQuality } from './generic_kVlG5M29.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_DhS1o7u2.mjs').then(n => n.i)).default;
  } catch {
